export default function Research() {
  return (
    <>
      <style>{`
        .rs-card { background:#0d1117;border:1px solid rgba(255,255,255,0.06);border-radius:16px;padding:28px;transition:all 0.3s; }
        .rs-card:hover { border-color:rgba(0,212,255,0.25);transform:translateY(-4px); }
      `}</style>

      <section id="research" style={{ padding: '80px 0', borderTop: '1px solid rgba(255,255,255,0.05)', position: 'relative', zIndex: 1 }}>
        <div style={{ maxWidth: 1080, margin: '0 auto', padding: '0 48px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
            <div className="rs-card">
              ...
              <div style={{ fontSize: 13, color: '#8892a4', lineHeight: 1.7, marginBottom: 18, fontWeight: 300 }}>Hybrid masked autoencoder and vision transformer architecture for high-precision medical image segmentation with limited labeled data.</div>
